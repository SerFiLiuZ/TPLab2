...
Выводы:
В рамках лаборатоной работы было разработано WEB-приложение для магазина предметов роскаши. Для него были составлены модульные и unit-тесты. Были получены навыки разработки WEB-приложений с использование MVC-фреймфорков.
